...
def buy_main_body(mutex2, api, bidirection, partition, _money, _coin, min_size,
    ...
    while True:
        try:
            ...
            real_buy_step_size = 10*min_size
            real_sell_step_size = 10*min_size
...
if __name__ == '__main__':
    ...
    load_money = "usdt"
    total_load_coin="eos eth ltc trx etc zec xlm ada btc bch xrp ft ada dash bsv iota fmex"
    load_coin = "ltc etc eos eth etc zec xlm"
    load_parition="2"
